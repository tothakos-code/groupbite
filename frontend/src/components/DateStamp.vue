<template>
  <div class="row d-flex justify-content-end">
    <div class="col my-auto">
      <div class="row d-flex justify-content-center align-items-center">
        <div class="col text-end">
          <button type="button" name="button" class="btn btn-link link-warning" :disabled="this.limitToCurrentWeek && this.currentDateSelected.getDay() == 1" @click="this.prevDay()">
        ...
        <div class="col text-start">
          <button type="button" name="button" class="btn btn-link link-warning" :disabled="this.limitToCurrentWeek && this.currentDateSelected.getDay() == 0" @click="this.nextDay()">
    ...
    <div class="col-2 my-auto">
      <button v-if="this.currentDate.getDate() !== this.currentDateSelected.getDate()" type="button" name="button" @click="this.jumpToPresentDay()" class="btn btn-warning">
        <span>Ma</span>
      </button>
    </div>
  </div>
