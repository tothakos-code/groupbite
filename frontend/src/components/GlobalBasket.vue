  ...
  <div class="card">
      <div class="align-items-center card-header row d-flex p-1">
        <div class="col-2 col-lg-1 my-auto">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-cart4 mb-1" viewBox="0 0 16 16">
        ...
        <div class="col-3 align-items-center p-0 text-center ms-auto">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cash-stack mb-1 me-1" viewBox="0 0 16 16">
